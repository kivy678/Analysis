...
class ProcessInfor:
    ...
    def getPid(self, pkgName) -> list:
        ...
        data = shell.runCommand(cmd, shell=True, name=self._name)
        if data == '':
    ...
    def getTPid(self, pid):
        ...
        m = shell.runCommand(cmd, shell=True, name=self._name)
    ...
    def getProcList(self) -> list:
        ...
        prc_list = [process.split() for process in data.split("\n")]
        return prc_list
